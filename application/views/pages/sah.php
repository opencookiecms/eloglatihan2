...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/alte/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Sila masukkan no badan</p>
  

    <?php  echo form_open('kursus/tumb');?>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nb" placeholder="No Badan">
        <input type="hidden" name='id' value="<?php echo $kursusid ?>"/>
        <input type="hidden" value="<?php echo $hari ?>" name="hari"/>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <p class="login-box-msg" style="font-size:30px; color:red"><b>ATAU</b></p> <p class="login-box-msg">No Kad Pengenalan</p>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="ic" placeholder="No Kad Pengenalan">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Semak</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script src="<?php echo base_url() ?>assets/alte/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
